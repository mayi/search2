...
HTMLElement.prototype.dopopup = function (
  width,
  height,
  vector,
  rotate,
  ...
  /*step*/
  var stepW = 2.5 * favrect.rectw,
    stepH = 2 * favrect.recth;
  var n = 2;
  ...
  var Fparabola = function (yn) {
    ...
    e.style.top = y + "px";
    e.style.left =
      (Math.pow(y, 2) / 10 - (doch / 50) * y) * k + docw / 2 - width + "px";
  };
      ...
      case "Y":
        if (w < width || h < height) {
          if (w < width) {
            ...
            if (vt == "CE" || vt == "RL" || vt == "TL" || vt == "BL")
              e.style.marginLeft =
                parseInt(e.style.marginLeft) - stepW / divisor + "px";
          }
          if (h < height) {
            if (vt != "LR" && vt != "RL") {
              e.style.height = h + stepH + "px";
            }
            if (vt == "CE" || vt == "BT" || vt == "BR" || vt == "BL")
              e.style.marginTop =
                parseInt(e.style.marginTop) - stepH / divisor + "px";
          }
          if (
            rotate &&
            vt != "TB" &&
            ...
            e.style.webkitTransform =
              "rotate(" +
              (parseFloat(
                e.style.webkitTransform.match("[0-9]+(.{1}[0-9]+)?")[0]
              ) +
                stepD) +
              "deg)";
  ...
  if (e.style.width == "0px" && e.style.height == "0px") {
    ...
    if (vt == "CE" || vt == "RL" || vt == "TL" || vt == "BL")
      e.style.marginLeft = width / divisor + "px";
    if (vt == "CE" || vt == "BT" || vt == "BR" || vt == "BL")
      e.style.marginTop = height / divisor + "px";
